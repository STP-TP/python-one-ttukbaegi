...
def restaurantDetail(request, res_id):
    ...
    # return HttpResponse("resstaurantDetail")
...
def Create_category(request):
    ...
    new_category.save()
    return HttpResponseRedirect(reverse('index'))
    # return HttpResponse("여기서 categroy Create 기능을 구현할거야")
